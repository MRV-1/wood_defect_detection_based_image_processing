...
def hsv_value(img,hsv):
    ...
    while(1):
         ...
         #reading trackbar values (what to get, from which window)
...
img= cv2.imread("C:/Users/MerveOZKAN/Desktop/lamella_opencv_project/oak_fungal_cropped_canny/mese_mantar_0005_cropped.JPG")
