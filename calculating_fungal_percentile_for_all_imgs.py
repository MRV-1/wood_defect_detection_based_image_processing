...
def prepercentage(result,img):
    ...
    print("Color pixel of count :", sum_color_pixel_count)
    print("Sum of pixel of count :", sum_pixel_count)
    percentage = get_percentage(sum_color_pixel_count, sum_pixel_count)
    print("Proportion of fungal on the lamella : %", percentage)    
    return percentage
...
def save_all_percentile_information(filename, percentage,text_file_name):
    with open('C:/Users/MerveOZKAN/Desktop/lamella_opencv_project/mese_mantar_masked_percentile/readme.txt', 'a') as f:  
